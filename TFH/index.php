...
<body>
	...
	<div class="limiter">
		<div class="container-table100">
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column9">Rencana Uitzet</th>
									<th class="cell100 column10">Rencana PCM</th>
									<th class="cell100 column11">Rencana MC50</th>
									<th class="cell100 column12">Rencana PHO</th>
			...
			$query = mysqli_query($koneksi, "SELECT * FROM tb_utama LEFT JOIN tb_permohonan ON tb_utama.id = tb_permohonan.id LEFT JOIN tb_fisarpras ON tb_permohonan.id = tb_fisarpras.id ORDER BY tglmasuk DESC LIMIT $mulai, $halaman");
            $no = 1;
            if ($query->num_rows > 0) {
